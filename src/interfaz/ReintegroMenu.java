 ...
 * @author Vladimir
 */
public class ReintegroMenu extends javax.swing.JFrame {

    /**
     * Creates new form buscar
     */
    public ReintegroMenu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Lista de Reintegros");
        ...
        jButton1.setText("Reitegrar Personal");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReintegroMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReintegroMenu().setVisible(true);
            }
        });
    }
