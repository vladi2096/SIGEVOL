 ...
 * @author Vladimir
 */
public class BuscarCedula extends javax.swing.JFrame {
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        persona person = personaConsulta.obtenerPersona("", Integer.parseInt(nombre.getText()), "Activo");
        if(person.getNombre() != null){
            contactoEmergencia contacto = contactoEmergenciaConsulta.obtenerContactoEmergencia(Integer.parseInt(nombre.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarCedula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new BuscarCedula().setVisible(true);
        });
    }
